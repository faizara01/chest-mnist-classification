...
EPOCHS = 16  # Increased epochs for deeper network
BATCH_SIZE = 32
LEARNING_RATE = 0.001  # Adjusted for ResNet
WEIGHT_DECAY = 0.0001
...
def train_resnet():
    ...
    # Learning rate scheduler - modified for ResNet
